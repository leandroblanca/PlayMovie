const peliculasIniciales = [
...

  {
    ...
    anio: 2017,
    descripcion:
      "Un grupo de niños enfrenta a una entidad maligna que toma la forma de un payaso.",
  },

  {
    ...
    anio: 2018,
    descripcion:
      "Un sacerdote investiga la misteriosa muerte de una monja en un convento embrujado.",
  },

  {
    ...
    anio: 2010,
    descripcion:
      "Una familia intenta salvar a su hijo que ha quedado atrapado en un mundo paranormal.",
  },

  {
    ...
    anio: 1995,
    descripcion:
      "Los juguetes de un niño cobran vida cuando el no esta y viven grandes aventuras.",
  },

  {
    ...
    anio: 2013,
    descripcion:
      "Una princesa con poderes de hielo intenta controlar sus habilidades y salvar su reino.",
  },

  {
    ...
    anio: 2001,
    descripcion:
      "Un ogro gruñon emprende una aventura para rescatar a una princesa y recuperar su pantano.",
  },

  {
    ...
    anio: 1994,
    descripcion:
      "Un joven leon debe aceptar su destino como rey despues de la muerte de su padre.",
  },
...

  {
    ...
    anio: 2014,
    descripcion:
      "La desaparicion de una mujer convierte a su esposo en el principal sospechoso.",
  },

  {
    ...
    anio: 2013,
    descripcion:
      "Un padre desesperado busca justicia cuando su hija desaparece.",
  },

  {
    ...
    anio: 2010,
    descripcion:
      "Un detective investiga la desaparicion de una paciente en un hospital psiquiatrico.",
  },

  {
    ...
    anio: 2009,
    descripcion:
      "Tres amigos despiertan despues de una despedida de soltero sin recordar lo ocurrido.",
  },

  {
    ...
    anio: 2008,
    descripcion:
      "Dos hombres inmaduros se convierten en hermanastros y compiten por todo.",
  },

  {
    ...
    anio: 2000,
    descripcion:
      "Un general romano traicionado busca venganza convirtiendose en gladiador.",
  },

  {
    ...
    anio: 2018,
    descripcion:
      "Ethan Hunt debe detener una amenaza global despues de que una mision sale mal.",
  },
];
